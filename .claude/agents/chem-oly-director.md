...
- Build `references/PAST_SETUPS.md` and `references/STYLE_CARD.md` once before dispatching Brainstorm; pass both to subagents instead of the raw `references/past_tests/`. No subagent may open `references/past_tests/`.
